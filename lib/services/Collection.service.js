...
exports.getCollection = exports.deleteCollection = exports.patchCollection = exports.getCollections = undefined;
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 10:
            return _context.abrupt('return', _promise2.default.resolve(collections));
...
var patchCollection = exports.patchCollection = function () {
  var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(collectionId, collectionData) {
    ...
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 10:
            return _context2.abrupt('return', _promise2.default.resolve(updatedCollection));
  ...
  return function patchCollection(_x, _x2) {
    return _ref2.apply(this, arguments);
  };
}();

var deleteCollection = exports.deleteCollection = function () {
  var _ref3 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3(collectionId) {
...
var getCollection = exports.getCollection = function () {
    ...
    return _regenerator2.default.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 10:
            return _context4.abrupt('return', _promise2.default.resolve(collection));
  ...
  return function getCollection(_x4) {
